...
def main():
    ...
    try:
        ...
        monitor_cmd = (
            ...
            "control_port=$(ss -tn state established dst 10.0.0.3:5201 2>/dev/null | awk 'NR==2 {split($4, a, \":\"); print a[2]}') || echo ''; "  # 修复ss命令
        ...
        start_time = time()
        # 修改iperf命令保存原始日志
        iperf_output = h1.cmd(f'iperf3 -c 10.0.0.3 -t 5 -C cubic --port 5201 > {throughput_log} 2>&1')
        end_time = start_time + 5
        print(f"[DEBUG] iperf3客户端命令已执行")
